...
import com.sht.diarysoftware.db.Diary;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabWrite.setOnClickListener(new com.sht.diarysoftware.NoDoubleClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                Intent intent=new Intent(MainActivity.this, com.sht.diarysoftware.EditDiaryActivity.class);
        ...
        switch (TYPE){
            case GENERAL_TYPE:
                 ...
                 */
                adapter=new com.sht.diarysoftware.DiaryAdapter(diaryList);
                break;
            case SIMPLE_TYPE:
                adapter=new com.sht.diarysoftware.SimpleDiaryAdapter(diaryList);
                break;
        }
